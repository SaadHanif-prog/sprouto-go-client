      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-bold m-0">Privacy Policy</h1>
          </div>
          ...
          <div className="space-y-12 text-slate-300">
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">1. Important Information and Who We Are</h2>
              <h3 className="text-xl font-medium text-white mt-6 mb-3">Purpose of this Privacy Policy</h3>
              <p>This privacy policy aims to give you information on how SproutoGO collects and processes your personal data through your use of this website and our services, including any data you may provide when you sign up for our platform, purchase a service, or interact with our AI engine Go's and bio-diverse system.</p>
              <p>This website is not intended for children and we do not knowingly collect data relating to children.</p>
              
              <h3 className="text-xl font-medium text-white mt-6 mb-3">Controller</h3>
              <p>SproutoGO is the controller and responsible for your personal data (collectively referred to as "SproutoGO", "we", "us" or "our" in this privacy policy).</p>
              
              <h3 className="text-xl font-medium text-white mt-6 mb-3">Contact Details</h3>
              <p>If you have any questions about this privacy policy or our privacy practices, please contact our Data Protection Officer (DPO) in the following ways:</p>
              <div className="mt-4 p-6 bg-white/5 rounded-xl border border-white/10">
                <p className="font-medium text-white mb-2">Full name of legal entity: SproutoGO</p>
              ...
              <p className="mt-4 text-sm text-slate-400">You have the right to make a complaint at any time to the Information Commissioner's Office (ICO), the UK regulator for data protection issues (www.ico.org.uk). We would, however, appreciate the chance to deal with your concerns before you approach the ICO so please contact us in the first instance.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-4 space-y-3">
                ...
                <li><strong>Financial Data</strong> includes bank account and payment card details (processed securely via our payment providers; we do not store full card details).</li>
                <li><strong>Transaction Data</strong> includes details about payments to and from you and other details of products and services you have purchased from us.</li>
                <li><strong>Technical Data</strong> includes internet protocol (IP) address, your login data, browser type and version, time zone setting and location, browser plug-in types and versions, operating system and platform, and other technology on the devices you use to access this website.</li>
                <li><strong>Profile Data</strong> includes your username and password, purchases or orders made by you, your interests, preferences, feedback and survey responses.</li>
                <li><strong>Usage Data</strong> includes information about how you use our website, products and services, including interactions with our AI engine Go's.</li>
                <li><strong>Marketing and Communications Data</strong> includes your preferences in receiving marketing from us and our third parties and your communication preferences.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">3. How Is Your Personal Data Collected?</h2>
              ...
              <ul className="list-disc pl-6 mt-4 space-y-3">
                ...
                <li><strong>Third parties or publicly available sources.</strong> We will receive personal data about you from various third parties such as analytics providers (e.g., Google), advertising networks, and search information providers.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">4. How We Use Your Personal Data & Legal Basis</h2>
              <p>We will only use your personal data when the law allows us to. Most commonly, we will use your personal data in the following circumstances:</p>
              <ul className="list-disc pl-6 mt-4 space-y-3">
                <li><strong>Performance of Contract:</strong> Where we need to perform the contract we are about to enter into or have entered into with you (e.g., providing our bio-diverse system services).</li>
                ...
                <li><strong>Consent:</strong> Generally, we do not rely on consent as a legal basis for processing your personal data although we will get your consent before sending third-party direct marketing communications to you via email or text message.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">5. Disclosures of Your Personal Data</h2>
              <p>We may share your personal data with the parties set out below for the purposes set out in Section 4:</p>
              <ul className="list-disc pl-6 mt-4 space-y-3">
                <li>Internal Third Parties: Other companies in the SproutoGO Group acting as joint controllers or processors.</li>
                <li>External Third Parties: Service providers acting as processors based in the UK, EEA, or US who provide IT and system administration services, including AI processing partners.</li>
                <li>Professional advisers acting as processors or joint controllers including lawyers, bankers, auditors and insurers.</li>
                <li>HM Revenue & Customs, regulators and other authorities acting as processors or joint controllers based in the United Kingdom.</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-4 space-y-3">
                ...
                <li>Where we use certain service providers, we may use specific contracts approved for use in the UK which give personal data the same protection it has in the UK (e.g., International Data Transfer Agreement or Addendum).</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">9. Your Legal Rights</h2>
              ...
              <p className="mt-4">If you wish to exercise any of the rights set out above, please contact us at privacy@sprouto.com.</p>
