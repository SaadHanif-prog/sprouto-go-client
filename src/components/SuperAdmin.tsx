...
function SiteCard({ site }: { site: Site }) {
  ...
  const isDirty = liveUrl !== (site.liveUrl || '') || propertyId !== (site.propertyId || '');
    ...
    <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 space-y-4">
      ...
      <div className="space-y-4 pt-4 border-t border-white/5">
        ...
        <div className="space-y-2 pt-4 border-t border-white/5">
          <label className="text-xs font-semibold text-slate-500 uppercase">Google Analytics (Property ID)</label>
          <input
            type="text"
